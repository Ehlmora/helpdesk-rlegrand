 ...
 */
final class Version20200630121201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE user_id user_id INT DEFAULT NULL, CHANGE ticket_state_id ticket_state_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE user_id user_id INT NOT NULL, CHANGE ticket_state_id ticket_state_id INT DEFAULT 1 NOT NULL');
        $this->addSql('ALTER TABLE ticket_log MODIFY id INT NOT NULL');
